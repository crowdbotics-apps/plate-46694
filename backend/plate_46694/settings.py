"""
Django settings for plate_46694 project.
...
WSGI_APPLICATION = 'plate_46694.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "plate_46694 API",
    "DESCRIPTION": "API documentation for plate_46694 App",
    "VERSION": "v1",
}
